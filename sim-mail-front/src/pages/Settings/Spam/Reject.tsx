...
const Reject = () => {
  ...
  const [selectedSubTab, setSelectedSubTab] = useState('reject');
      ...
      <div className="flex gap-5 relative sm:h-[calc(100vh_-_110px)] h-full">
        <div className="panel p-0 flex-1 overflow-x-hidden h-full">
          <div className="relative">
            ...
            <SubMenu subMenuTab={'reject'} />

            <div className="py-4 px-6 flex items-center gap-5 md:gap-20">
              <div className="w-60">수신차단 메일 주소/도메인 추가</div>
                  ...
                  <ul className="h-48 overflow-auto">
                    <li>
                      <label className="inline-flex">
                        ...
                        <span className="peer-checked:text-primary">test@daum.net</span>
                      </label>
                    </li>
                    <li>
                      <label className="inline-flex">
