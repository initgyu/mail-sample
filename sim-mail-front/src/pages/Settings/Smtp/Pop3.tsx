...
const Pop3 = () => {
  ...
  const [selectedSubTab, setSelectedSubTab] = useState('pop3');
      ...
      <div className="flex gap-5 relative sm:h-[calc(100vh_-_110px)] h-full">
        <div className="panel p-0 flex-1 overflow-x-hidden h-full">
          <div className="relative">
            ...
            <SubMenu subMenuTab={'pop3'} />

            <div className="py-4 px-6 flex items-center gap-5 md:gap-20">
              <div className="w-60">POP3/SMTP 사용</div>
              <div className="flex flex-col">
                ...
                <div className="pt-2 text-white-dark">
                  스마트폰, 아웃룩 등에서 메일을 확인할 수 있도록 POP3/SMTP를 설정합니다.
                </div>
              </div>
            </div>
            ...
            <div className="py-4 px-6 flex flex-col">
              <div className="font-bold">메일 프로그램 환경 설정 안내</div>
              <div className="text-white-dark">
                스마트폰, 아웃룩 등 외부 메일 프로그램 환경설정에 아래와 같이 등록해 주세요.
              </div>
            </div>
            ...
            <div className="py-4 px-6 flex items-center gap-5 md:gap-20">
              ...
              <div className="w-60">POP 서버명 : pop.naver.com</div>
            ...
            <div className="py-4 px-6 flex items-center gap-5 md:gap-20">
              ...
              <div className="w-60">POP 포트 : 995, 보안연결(SSL) 필요</div>
              <div className="w-60">SMTP 포트 : 465, 보안 연결(SSL) 필요</div>
            </div>
            ...
            <div className="py-4 px-6 flex items-center gap-5 md:gap-20">
              ...
              <div className="w-60 text-white-dark">POP3/SMTP 연결이 되지 않아요</div>
              <div className="w-60 text-white-dark">메일 프로그램 POP3/SMTP 설정하기</div>
            </div>
          </div>
        </div>
      </div>
