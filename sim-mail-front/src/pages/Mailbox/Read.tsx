...
const Read = () => {
  ...
  const [selectedMail, setSelectedMail] = useState<any>(mailList[0]);
            ...
            <div className="flex items-center justify-between flex-wrap p-4">
              <div className="flex items-center">
                <button
                  ...
                  onClick={() =>
                    navigate({
                      pathname: `/mailbox/List`,
                    })
                  }
                >
                  <IconArrowLeft className="w-5 h-5 rotate-180" />
                </button>
                <h4 className="text-base md:text-lg font-medium ltr:mr-2 rtl:ml-2">전체메일</h4>
                <h4 className="text-base md:text-lg font-medium ltr:mr-2 rtl:ml-2">
                  <span className="text-blue-500">748</span> / 3901
                </h4>
              </div>
              ...
              <div className="flex items-center justify-between flex-wrap p-4">
                <div className="flex items-center">
                  <Tippy content="Star">
                    <button
                      type="button"
                      className={`enabled:hover:text-warning disabled:opacity-60 ltr:mr-2 rtl:ml-2 ${
              ...
              <div className="flex flex-wrap">
                <div className="ltr:mr-2 rtl:ml-2 flex-1">
                  <div className="flex items-center w-full pl-4">
                    <div className="ltr:mr-2 rtl:ml-2">보낸사람 :</div>
                  ...
                  <div className="flex items-center w-full pl-4">
                    <div className="ltr:mr-2 rtl:ml-2">받는사람 :</div>
                    <div className="flex-1">
                      {selectedMail.type !== 'sent_mail' ? 'vristo@gmail.com' : selectedMail.email}
                    </div>
                  </div>
              ...
              {selectedMail.attachments && (
                <div className="mt-8">
                  ...
                  <div className="flex m-4">
                    <div>첨부파일 : 파일 {selectedMail.attachments.length}개</div>
                    <Button className="ml-8">모두저장</Button>
                  </div>
                    ...
                    {selectedMail.attachments.map((attachment: any, i: number) => {
                      return (
                        <button
                          key={i}
                          type="button"
                          className="flex items-center ltr:mr-4 rtl:ml-4 border border-white-light dark:border-[#1b2e4b] rounded-md hover:text-primary hover:border-primary transition-all duration-300 px-4 py-2.5 relative group"
                        >
